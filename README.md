# VAULTID - Secure Identity Authentication on Blockchain
...
![VAULTID - Blockchain Identity Authentication](https://via.placeholder.com/800x400?text=VAULTID+Identity+Authentication)

## How It Works

### System Architecture

The VAULTID system consists of three main components:
...
2. Open the frontend in your browser by navigating to:
   ```
   WALLET-TRUST/frontend/PII/PII/index.html
   ```
